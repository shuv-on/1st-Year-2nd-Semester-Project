...
void openApplication(const string& appName) {
    if (appName == "text editor") {
        system("gnome-text-editor &");  // Or use nano, vim as text editor
...
void openWebsite(const string& url) {
    string command = "xdg-open \"https://www." + url + "\".com";
    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                break;
            case 4:
                cout << "Enter website name:  (e.g., https://www.google.com): ";
                cin >> website;
                openWebsite(website);
                break;
